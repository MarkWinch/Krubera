...
class Scene14 extends Phaser.Scene {
    ...
    create(){
        ...
        platforms.create(29.5, 212, 'middlerock');
        platforms.create(200, 560, 'middlerock');
        platforms.create(400, 360, 'middlerock');
        platforms.create(400, 210, 'middlerock');
        platforms.create(550, 150, 'middlerock');
        platforms.create(735, 310, 'middlerock');

        this.add.image(550, 196, 'crystal');
