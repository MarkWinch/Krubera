...
class Scene23 extends Phaser.Scene {
    ...
    create(){
        ...
        platforms.create(29, 440, 'middlerock12side');
        platforms.create(400, 570, 'toprock15').setFlip(false, true);

        platforms.create(215, 300, 'middlerock3x3');
        platforms.create(389, 300, 'middlerock3x3');

        platforms.create(215, -25, 'middlerock3x3');
        platforms.create(389, -25, 'middlerock3x3');

        platforms.create(713, 90, 'middlerock3x3');
        platforms.create(713, 148, 'middlerock3x3');
        platforms.create(713, 455, 'middlerock3x3');

        var doorplatform1 = this.add.image(273, 219, 'bouncer');
        ...
        wall_spikes.create(219, 205, 'spikes');
        wall_spikes.create(328, 205, 'spikes');
        wall_spikes.create(655, 242, 'spikes').setFlip(false, true);
        wall_spikes.create(715, 361, 'spikes');

        this.add.image(608, 205, 'crystal').setAngle(90);
