...
class Scene13 extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image('13top', 'assets/13top.png');
    ...
    create(){
        ...
        platforms.create(29.5, 552, 'middlerock');

        platforms.create(200, 800, '13top');

        platforms.create(342.625, 739.75, '13top');
        platforms.create(485.25, 679.5, '13top');
        platforms.create(627.875, 619.25, '13top');

        platforms.create(770.5, 559, '13top');

        wall_spikes = this.physics.add.staticGroup();
        wall_spikes.create(164, 451, 'spikesh');
        wall_spikes.create(306.625, 390.75, 'spikesh');
        wall_spikes.create(449.25, 330.5, 'spikesh');
        wall_spikes.create(591.875, 270.25, 'spikesh');
        wall_spikes.create(734.5, 210, 'spikesh');

        this.add.image(531, 334, 'crystal').setAngle(270);
