...
class Scene29 extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image('middlerock2x2', 'assets/middlerock2x2.png');
        this.load.image('toprock', 'assets/toprock.png');
    ...
    create(){
        ...
        platforms.create(-29, 280, 'middlerock3x3');
        platforms.create(29, 135, 'middlerock6side');

        platforms.create(29, 396, 'middlerock');
        platforms.create(29, 454, 'middlerock');
        platforms.create(-29, 570, 'middlerock3');

        platforms.create(771, 85, 'middlerock3x3');
        platforms.create(771, 515, 'middlerock3x3');

        platforms.create(240, 130, 'middlerock2x2');
        platforms.create(240, 450, 'middlerock2x2');

        platforms.create(550, 130, 'middlerock2x2');
        platforms.create(550, 450, 'middlerock2x2');

        platforms.create(400, 300, 'toprock');

        this.add.image(315, 130, 'crystal').setAngle(270);
