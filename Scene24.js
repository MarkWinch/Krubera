...
class Scene24 extends Phaser.Scene {
    ...
    create(){
        ...
        platforms.create(29, 90, 'middlerock3x3');
        platforms.create(29, 148, 'middlerock3x3');
        platforms.create(29, 455, 'middlerock3x3');
        platforms.create(29, 571, 'middlerock3x3');

        platforms.create(713, 148, 'middlerock3x3');
        platforms.create(713, 371, 'middlerock3x3');
        platforms.create(713, 522, 'middlerock3x3');

        platforms.create(400, 413, 'middlerock2');
        platforms.create(400, 471, 'middlerock2');

        platforms.create(237, 311, 'smallplatform');
        platforms.create(525, 170, 'smallplatform');

        wall_spikes = this.physics.add.staticGroup();
        wall_spikes.create(370, 376, 'spikes');

        var bouncer = this.add.image(429, 389, 'bouncer');
        this.physics.add.existing(bouncer);
        bouncer.body.setAllowGravity(false);
        bouncer.body.setImmovable();

        this.add.image(400, 518, 'crystal');
