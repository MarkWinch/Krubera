...
class Scene20 extends Phaser.Scene {
    ...
    create(){
        ...
        platforms.create(568, 5, 'middlerock12side');
        platforms.create(626, 5, 'middlerock12side');

        platforms.create(568, 830, 'middlerock12side');
        platforms.create(626, 830, 'middlerock12side');

        platforms.create(-30, 170, 'block7');
        platforms.create(-30, 320, 'block7');

        platforms.create(400, 30, 'toprock15');
        platforms.create(-385, 570, 'toprock15').setFlip(false, true);

        platforms.create(185, 570, 'middlerock3up');
        platforms.create(243, 570, 'middlerock3up');

        platforms.create(358, 500, 'middlerock12side');
        platforms.create(416, 500, 'middlerock12side');

        platforms.create(730, 435, 'middlerock');
        platforms.create(730, 275, 'middlerock');
        platforms.create(771, 171, 'middlerock');

        wall_spikes = this.physics.add.staticGroup();
        wall_spikes.create(570, 475, 'spikes');

        var bouncer = this.add.image(215, 490, 'bouncer');
        this.physics.add.existing(bouncer);
        bouncer.body.setAllowGravity(false);
        bouncer.body.setImmovable();


        this.add.image(463, 300, 'crystal').setAngle(270);
