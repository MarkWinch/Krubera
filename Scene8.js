...
class Scene8 extends Phaser.Scene {
    ...
    create(){
        ...
        platforms.create(771, 445, 'middlerock6side');

        platforms.create(400, 30, 'toprock15');
        platforms.create(400, 570, 'toprock15').setFlip(false, true);

        platforms.create(-324, 359, 'toprock15');
        platforms.create(-324, 300, 'toprock15').setFlip(false, true);
        ...
        boosters.create(216, 549, 'bouncer');
        boosters.create(326, 549, 'bouncer');
        boosters.create(436, 549, 'bouncer');
        boosters.create(546, 549, 'bouncer');
        boosters.create(656, 549, 'bouncer');

        var bridge = this.add.image(88, 278, 'bouncer');
        this.physics.add.existing(bridge);
        bridge.body.setAllowGravity(false);
        bridge.body.setImmovable();

        this.add.image(550, 76, 'crystal');
        ...
        this.physics.add.collider(player, bridge, function (_player, _bridge)
        {
            ...
            bridge_platform.setPosition(560, 300);
        }
        );
