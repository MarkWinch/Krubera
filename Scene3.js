...
class Scene3 extends Phaser.Scene {
    ...
    create(){
        ...
        this.add.image(608, 220, 'crystal').setAngle(90);

        platforms = this.physics.add.staticGroup();

        platforms.create(771, 415, 'middlerock3up');
        platforms.create(771, 475, 'middlerock3up');

        platforms.create(400, -8, 'toprock15');
        platforms.create(400, 570, 'toprock15').setFlip(false, true);

        platforms.create(27, 216, 'toprock5').setFlip(false, true);
        platforms.create(88, 275, 'middlerock3');

        platforms.create(420, 315, 'middlerock2');
        platforms.create(420, 372, 'middlerock2');

        platforms.create(713, 183, 'middlerock3');
        platforms.create(713, 241, 'middlerock3');
        platforms.create(713, 299, 'middlerock3');
