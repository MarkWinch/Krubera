...
class Scene7 extends Phaser.Scene {
    ...
    create(){
        ...
        platforms.create(620, 359, 'toprock15');
        platforms.create(620, 300, 'toprock15').setFlip(false, true);
        platforms.create(400, 570, 'toprock15').setFlip(false, true);
        platforms.create(30, 513, 'middlerock3up');

        boosters = this.physics.add.staticGroup();
        boosters.create(266, 278, 'bouncer');
        boosters.create(376, 278, 'bouncer');
        boosters.create(488, 278, 'bouncer');
        boosters.create(546, 278, 'bouncer');
        boosters.create(656, 278, 'bouncer');
        boosters.create(756, 278, 'bouncer');

        wall_spikes = this.physics.add.staticGroup();
        wall_spikes.create(315, 66, 'spikes7').setFlip(false, true);
        wall_spikes.create(668, 66, 'spikes7').setFlip(false, true);

        ball1 = this.add.image(970, 400, 'ball').setScale(2);
        this.physics.add.existing(ball1);
        ball1.body.setAllowGravity(false);
        ball1.body.setImmovable();
        ball1.body.setVelocityX(-840);

        ball2 = this.add.image(780, 500, 'ball').setScale(2);
        this.physics.add.existing(ball2);
        ball2.body.setAllowGravity(false);
        ball2.body.setImmovable();
        ball2.body.setVelocityX(-840);

        this.add.image(159, 310, 'crystal').setAngle(90);
        ...
        this.physics.add.collider(player, boosters, function (_player, _boosters)
        {
    ...
    update(){
        ...
        if (ball1.x < 0) {
            ball1.setPosition(780,430);
        }

        if (ball2.x < 0) {
            ball2.setPosition(780,520);
        }
