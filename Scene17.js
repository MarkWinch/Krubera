...
class Scene17 extends Phaser.Scene {
    ...
    create(){
        ...
        platforms.create(-384, 570, 'toprock15').setFlip(false, true);

        platforms.create(29, 300, 'middlerock6side');

        platforms.create(711, 147, 'block1');
        platforms.create(711, 482, 'block2');
        platforms.create(481, 31, 'block3');
        platforms.create(481, 561, 'block4');
        platforms.create(252, 117, 'block5');
        platforms.create(251, 482, 'block6');
        platforms.create(483, 292, 'block7');

        this.add.image(607, 264, 'crystal').setAngle(90);
