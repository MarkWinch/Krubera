...
class Scene11 extends Phaser.Scene {
    ...
    create(){
        ...
        platforms.create(59, 408, 'middlerock2');

        platforms.create(712, 199, 'middlerock3x3');
        platforms.create(365, 315, 'middlerock3x3');
        platforms.create(538, 257, 'middlerock3x3');
        platforms.create(538, 373, 'middlerock3x3');
        platforms.create(712, 373, 'middlerock3x3');
        platforms.create(712, 431, 'middlerock3x3');
        platforms.create(88, 524, 'middlerock3x3');
        platforms.create(204, 524, 'middlerock3up');
        platforms.create(320, 582, 'middlerock3x3');
        platforms.create(494, 640, 'middlerock3x3');
        platforms.create(668, 661, 'middlerock3x3');
        platforms.create(842, 661, 'middlerock3x3');
        platforms.create(712, -20, 'middlerock3x3');
        platforms.create(538, -20, 'middlerock3x3');
        platforms.create(364, 38, 'middlerock3x3');
        platforms.create(190, 37, 'middlerock3x3');
        platforms.create(190, 96, 'middlerock3x3');
        platforms.create(74, 154, 'middlerock3x3');
        platforms.create(74, -20, 'middlerock3x3');
        platforms.create(249, 315, 'middlerock');

        this.add.image(535, 477, 'crystal');
